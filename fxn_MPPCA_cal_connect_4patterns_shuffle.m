function [Cells_sum] = fxn_MPPCA_cal_connect_4patterns_shuffle(temp_ca_shuffled, P1_unique, P2_unique, P3_unique, P4_unique, binarize_thr, i_shuffle)
%% comment
% for ensemble shuffling
%%
% 230316 modified for Ali.
temp_ca_A = temp_ca_shuffled{1}{i_shuffle, 1}(:, P1_unique);
temp_ca_B = temp_ca_shuffled{1}{i_shuffle, 1}(:, P2_unique);
temp_ca_C = temp_ca_shuffled{1}{i_shuffle, 1}(:, P3_unique);
temp_ca_D = temp_ca_shuffled{1}{i_shuffle, 1}(:, P4_unique);
